...
const projects = [
  ...
  },
  {
    ...
    role: 'Frontend & Backend',
    technologies: ['Next.js', 'PostgreSQL', 'AWS', 'React Query', 'TypeScript'],
  ...
  },
  {
    ...
    role: 'Frontend & Backend',
    technologies: ['Next.js', 'PostgreSQL', 'Node.js', 'Stripe', 'Docker'],
  ...
  },
  {
    ...
    role: 'Frontend Development',
    technologies: ['React', 'TypeScript', 'WebRTC', 'AI APIs'],
  ...
  },
  {
    ...
    technologies: ['React Native', 'TypeScript', 'Web3.js'],
    link: '#',
    company: 'Vyntrics',
  },
  {
  ...
  },
  {
    ...
    role: 'Frontend & Backend',
    technologies: ['Next.js', 'PostgreSQL', 'Node.js', 'Docker', 'AWS'],
    link: '#',
    company: 'OOps 24x7',
  },
  {
    title: 'Coupon & E-Commerce ERP',
    description: 'Integrated coupon management and e-commerce ERP with multi-language support.',
    role: 'Frontend & Backend',
    technologies: ['Next.js', 'PostgreSQL', 'Express', 'React Query'],
    link: 'https://coupzone.com',
    company: 'CoupZone',
  },
  {
    ...
    role: 'Frontend & Backend',
    technologies: ['React', 'Node.js', 'Face.js', 'AI APIs', 'PostgreSQL'],
    link: '#',
  ...
  },
  {
    ...
    technologies: ['Node.js', 'Express', 'WebSocket', 'PostgreSQL', 'HLS Streaming'],
  ...
  },
  {
    ...
    role: 'Backend Development',
    technologies: ['Node.js', 'Express', 'PostgreSQL', 'Third-party APIs', 'Payment Gateway'],
